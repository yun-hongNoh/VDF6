...
const engine={id:'test',version:'6.0.0',status:'STABLE',label:'VDF 6.0 Stable',instruction:validInstruction,rules:validRules,rulesJson:{},contract:{},rulesHash:'r',instructionHash:'i',contractHash:'c',registeredAt:'2026-01-01',source:'BUILT_IN',regression:'AVAILABLE',manifest:{engine:'VDF',version:'6.0.0'}} as EngineDef;
